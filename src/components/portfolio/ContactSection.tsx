        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              {personalInfo.email && (
                <a href={`mailto:${personalInfo.email}`} className={`group flex items-center gap-4 p-4 sm:p-5 rounded-2xl border border-slate-200 hover:border-slate-300 hover:shadow-lg transition-all duration-300 ${theme.bgLight}`}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-slate-900 font-medium text-sm sm:text-base truncate">{personalInfo.email}</p>
                  </div>
                </a>
              )}
              {personalInfo.phone && (
                <a href={`tel:${personalInfo.phone}`} className={`group flex items-center gap-4 p-4 sm:p-5 rounded-2xl border border-slate-200 hover:border-slate-300 hover:shadow-lg transition-all duration-300 ${theme.bgLight}`}>
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 ${theme.bg} rounded-xl flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform`}>
                    <span className="text-xl sm:text-2xl">📱</span>
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm text-slate-500">Phone</p>
                    <p className="text-slate-900 font-medium text-sm sm:text-base">{personalInfo.phone}</p>
                  </div>
                </a>
              )}
              {personalInfo.location && (
                <div className={`flex items-center gap-4 p-4 sm:p-5 rounded-2xl border border-slate-200 ${theme.bgLight}`}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-slate-900 font-medium text-sm sm:text-base">{personalInfo.location}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          {/* Right Side - Form */}
          <div className="bg-slate-50 rounded-3xl p-6 sm:p-8 lg:p-10">
            ...
            <form className="space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input 
                  ...
                  className={`w-full px-4 sm:px-5 py-3 sm:py-4 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 ${theme.ring} text-sm sm:text-base transition-all duration-200`}
                />
                <input 
                  type="email" 
              ...
              <textarea 
                ...
                rows={5}
                className={`w-full px-4 sm:px-5 py-3 sm:py-4 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 ${theme.ring} resize-none text-sm sm:text-base transition-all duration-200`}
              ></textarea>
              <button 
                type="submit"
...
const CardContact = ({ data, theme }: ContactProps) => {
  ...
  return (
    <section id="contact" className={`py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br ${theme.gradient} relative overflow-hidden`}>
      {/* Animated background */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <CometCard 
          ...
          showMeteors={false}
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-4 sm:mb-6">
              Let&apos;s Connect
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-8 sm:mb-12 max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
              {personalInfo.email && (
                <a 
                  href={`mailto:${personalInfo.email}`} 
                  className={`group p-5 sm:p-6 bg-slate-50 rounded-2xl hover:bg-slate-100 transition-all duration-300 hover:shadow-lg hover:-translate-y-1`}
                >
                  ...
                  <p className="text-slate-900 font-medium text-xs sm:text-sm truncate">{personalInfo.email}</p>
                </a>
              )}
              {personalInfo.linkedin && (
                <a 
                ...
                >
                  ...
                  <p className="text-slate-900 font-medium text-xs sm:text-sm">Connect</p>
                </a>
              )}
              {personalInfo.github && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className={`group p-5 sm:p-6 bg-slate-50 rounded-2xl hover:bg-slate-100 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 sm:col-span-2 lg:col-span-1`}
                >
                  <span className="text-3xl sm:text-4xl block mb-3 group-hover:scale-110 transition-transform">💻</span>
                  <p className="text-xs sm:text-sm text-slate-500 mb-1">GitHub</p>
                  <p className="text-slate-900 font-medium text-xs sm:text-sm">View Profile</p>
                </a>
              )}
            </div>
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-8 sm:mb-12">Contact</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          {personalInfo.email && (
            <a 
              href={`mailto:${personalInfo.email}`} 
              className={`group flex items-center gap-4 p-5 sm:p-6 border border-slate-200 rounded-2xl hover:border-slate-400 hover:shadow-md transition-all duration-300`}
            >
          ...
          {personalInfo.phone && (
            <a 
              ...
              className={`group flex items-center gap-4 p-5 sm:p-6 border border-slate-200 rounded-2xl hover:border-slate-400 hover:shadow-md transition-all duration-300`}
            >
              <span className={`text-2xl text-slate-600 group-hover:${theme.primary} group-hover:scale-110 transition-all`}>→</span>
              <div className="min-w-0 flex-1">
                <p className="text-xs text-slate-400 mb-1">Phone</p>
                <p className="text-slate-700 font-medium text-sm sm:text-base">{personalInfo.phone}</p>
              </div>
            </a>
          )}
          {personalInfo.linkedin && (
        ...
        <p className="text-slate-400 text-xs sm:text-sm mt-12 sm:mt-16">
...
const FloatingContact = ({ data, theme }: ContactProps) => {
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-100 relative overflow-hidden">
      {/* Animated Background Blobs */}
      <div className="absolute inset-0 overflow-hidden">
        <div className={`absolute top-10 sm:top-20 left-5 sm:left-10 w-48 sm:w-72 h-48 sm:h-72 ${theme.bg} rounded-full blur-3xl opacity-20 animate-pulse`}></div>
        <div className={`absolute bottom-5 sm:bottom-10 right-10 sm:right-20 w-64 sm:w-96 h-64 sm:h-96 ${theme.bg} rounded-full blur-3xl opacity-15 animate-pulse`} style={{ animationDelay: '1s' }}></div>
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 sm:w-80 h-56 sm:h-80 ${theme.bg} rounded-full blur-3xl opacity-10 animate-pulse`} style={{ animationDelay: '2s' }}></div>
      </div>
      
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-slate-900 mb-4 sm:mb-6">
            Say Hello!
          </h2>
          <p className="text-base sm:text-xl text-slate-600">I&apos;d love to hear from you</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto">
          {personalInfo.email && (
            <a 
              href={`mailto:${personalInfo.email}`}
              className="group flex items-center gap-4 px-6 sm:px-8 py-5 sm:py-7 bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
            >
              <span className="text-2xl sm:text-3xl group-hover:scale-110 transition-transform">✉️</span>
              <div className="min-w-0 flex-1">
                <p className="text-xs text-slate-400 mb-1">Email</p>
                <p className="font-medium text-slate-700 text-sm sm:text-base truncate">{personalInfo.email}</p>
              </div>
            </a>
          )}
          {personalInfo.phone && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs text-slate-400 mb-1">Phone</p>
                <p className="font-medium text-slate-700 text-sm sm:text-base">{personalInfo.phone}</p>
              </div>
            </a>
          )}
          {personalInfo.linkedin && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs text-slate-400 mb-1">LinkedIn</p>
                <p className="font-medium text-slate-700 text-sm sm:text-base">Connect with me</p>
              </div>
            </a>
          )}
          {personalInfo.github && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs text-slate-400 mb-1">GitHub</p>
                <p className="font-medium text-slate-700 text-sm sm:text-base">View my projects</p>
              </div>
            </a>
          )}
        </div>
        ...
        <div className="text-center mt-10 sm:mt-16">
          <p className="text-slate-500 text-xs sm:text-sm">© {new Date().getFullYear()} {personalInfo.name}. All rights reserved.</p>
        </div>
      </div>
    </section>
  );
